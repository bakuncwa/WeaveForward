(function() {
  ...
  var steps = [
    ...
    { target: '.tuab-dashboard-table tbody tr:first-child td:nth-child(2)', title: 'Donor Name', desc: 'See who donated so you know who you\'d coordinate with.' },
    { target: '.tuab-dashboard-table tbody tr:first-child td:nth-child(3)', title: 'Address', desc: 'Where the donation is located — decide if it\'s within your service area.' },
    { target: '.tuab-dashboard-table tbody tr:first-child td:nth-child(4)', title: 'Pick-Up Date', desc: 'When the donor wants the items picked up.' },
    { target: '.tuab-dashboard-table tbody tr:first-child td:nth-child(5)', title: 'Items', desc: 'How many clothing items are in the donation.' },
