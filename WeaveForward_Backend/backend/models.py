...
class User(AbstractBaseUser):
    ...
    min_biodeg_score   = models.DecimalField(max_digits=5,  decimal_places=2, null=True, default=None)
    max_distance_km    = models.DecimalField(max_digits=6,  decimal_places=2, null=True, default=None)
